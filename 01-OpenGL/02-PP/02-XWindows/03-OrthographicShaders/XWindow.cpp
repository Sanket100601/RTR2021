...
void draw(void)
{
    ...
    modelViewProjectionMatrix = orthographicProjectionMatrix * modelViewMatrix; // order is important A X B != B X A
...
void uninitialize(void)
{
    ...
    if (shaderProgramObject)
    {
        ...
        {
            fprintf(gpFile, "Failed shaderObject");
        }

        // fill with attached shader
