...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, OnGestureListener, OnDoubleTapListener, ScaleGestureDetector.OnScaleGestureListener
{
	...
	public boolean onScale(ScaleGestureDetector detector) {
		...
		System.out.println("amc:zoom ongoing, scale: " + detector.getScaleFactor());
		return false;
	}
	...
	public void onSurfaceCreated(GL10 gl,EGLConfig config){
		...
		System.out.println("amc: Shading lang version:"+ glslVersion);
	...
	public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY){	
		uninitialize();
		System.out.println("amc:on scroll exit");
		//System.exit(0);
		return true;
	}
	...
	private void initialize(GL10 gl){
		...
		GLES30.glBindAttribLocation(shaderProgramObject, GLESMacros.amc_ATTRIBUTE_VERTEX, "vPosition");
		GLES30.glBindAttribLocation(shaderProgramObject, GLESMacros.amc_ATTRIBUTE_TEXTURE0, "vTexture0_Coord");
		//link program
		...
		//load texture images
		System.out.println("amc:Before texture load: texture_stone:"+texture_stone[0] );
		System.out.println("amc:Before texture load: texture_kundali:"+texture_kundali[0] );
		texture_stone[0] = loadGLTexture(R.raw.stone);
		texture_kundali[0] = loadGLTexture(R.raw.kundali);
		
		System.out.println("amc:After texture load: texture_stone:"+texture_stone[0] );
		System.out.println("amc:After texture load: texture_kundali:"+texture_kundali[0] );
		...
		GLES30.glVertexAttribPointer(GLESMacros.amc_ATTRIBUTE_VERTEX, 3, GLES30.GL_FLOAT, false, 0, 0);
		
		GLES30.glEnableVertexAttribArray(GLESMacros.amc_ATTRIBUTE_VERTEX);
		...
		GLES30.glVertexAttribPointer(GLESMacros.amc_ATTRIBUTE_TEXTURE0, 2, GLES30.GL_FLOAT, false, 0, 0);
		
		GLES30.glEnableVertexAttribArray(GLESMacros.amc_ATTRIBUTE_TEXTURE0);
		GLES30.glBindBuffer(GLES30.GL_ARRAY_BUFFER, 0);
