...
-(void)keyDown:(NSEvent*)event
{
    ...
    switch(key)
    {
		...
		case 49:
			keypress = 1;
			fprintf(gpFile, "Log File Is Sucessfully 1 !!!\n");
		//	fclose(gpFile);
			break;

		case 50:
			keypress = 2;
			fprintf(gpFile, "Log File Is Sucessfully 2 !!!\n");
		//	fclose(gpFile);			
			break;
		...
		case 51:
			...
			fprintf(gpFile, "Log File Is Sucessfully 3 !!!\n");
			//fclose(gpFile);
			break;
		...
		case 52:
			keypress = 4;
			//glEnable(GL_TEXTURE_2D);
			fprintf(gpFile, "Log File Is Sucessfully 4 !!!\n");
			//fclose(gpFile);
			break;
		default:
			keypress = 0;
			fprintf(gpFile, "Log File Is Sucessfully 55 !!!\n");
			break;
    }
}
