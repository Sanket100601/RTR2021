...
GLboolean CircleToggleLine = TRUE;
GLboolean TriangleToggle = TRUE;
GLboolean SquareToggle = TRUE;
GLboolean GraphToggle = TRUE;
        ...
        switch(key)
        {
            ...
            case 'c':
                    case 'C':
                        if (CircleToggleLine == TRUE)
                        {
                            CircleToggleLine = FALSE;
                        }
                        else
                        {
                            CircleToggleLine = TRUE;
                        }
                        break;
