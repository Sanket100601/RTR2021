...
- (void)display
{
    ...
    mat4 translationMatrix = mat4::identity();
       ...
       //* @@@@@@@@@@@@@@@@@@@@@@@@@@@@ shoulder @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@*/
        ...
        rotationMatrix = vmath::rotate(shoulder, 0.0f, 0.0f, 1.0f);
        ...
        glVertexAttrib3f(AMC_ATTRIBUTE_COLOR, 0.5f, 0.35f, 0.5f);
       ...
       rotationMatrix = vmath::rotate(wrist, 0.0f, 0.0f, 1.0f);
        ...
        modelMatrix = modelMatrix * translationMatrix;
        scaleMatrix = vmath::scale(0.8f, 0.5f, 1.0f);
