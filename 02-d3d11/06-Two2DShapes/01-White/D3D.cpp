...
HRESULT initialise(void)
{
	...
	d3d11InputElementDescriptor.Format = DXGI_FORMAT_R32G32B32_FLOAT;
	...
	{
		fopen_s(&gpFile, "Log.txt", "a+");
		fprintf(gpFile, "Init() in gpID3D11Device::CreateBuffer() for Position Triangle Buffer  Failed!!!\n");
		fclose(gpFile);
		return hr;
	}
	else
	{
		fopen_s(&gpFile, "Log.txt", "a+");
		fprintf(gpFile, "Init() in gpID3D11Device::CreateBuffer() for Position Triangle Buffer  Successed!!!\n");
		fclose(gpFile);
	}
	...
	{
		fopen_s(&gpFile, "Log.txt", "a+");
		fprintf(gpFile, "Init() in gpID3D11Device::CreateBuffer() for Position Sqaure Buffer  Failed!!!\n");
		fclose(gpFile);
		return hr;
	}
	else
	{
		fopen_s(&gpFile, "Log.txt", "a+");
		fprintf(gpFile, "Init() in gpID3D11Device::CreateBuffer() for Position Sqaure Buffer  Successed!!!\n");
		fclose(gpFile);
	}
