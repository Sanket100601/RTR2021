...
ID3D11Buffer* gpID3D11Buffer_Texture_CubeBuffer = NULL;
ID3D11Buffer* gpID3D11Buffer_Position_PyramidBuffer = NULL;
ID3D11Buffer* gpID3D11Buffer_Texture_PyramidBuffer = NULL;
...
HRESULT initialise(void)
{
	...
	{
		fopen_s(&gpFile, "Log.txt", "a+");
		fprintf(gpFile, "Init() in gpID3D11Device::CreateBuffer() for Cube Position Buffer  Failed!!!\n");
		fclose(gpFile);
		return hr;
	}
	else
	{
		fopen_s(&gpFile, "Log.txt", "a+");
		fprintf(gpFile, "Init() in gpID3D11Device::CreateBuffer() for Cube Position Buffer  Successed!!!\n");
		fclose(gpFile);
	}
	...
	hr = gpID3D11Device->CreateBuffer(&d3d11BufferDescriptor,
		&d3d11SubResourceData,
		&gpID3D11Buffer_Texture_CubeBuffer);

	if (FAILED(hr))
	{
		fopen_s(&gpFile, "Log.txt", "a+");
		fprintf(gpFile, "Init() in gpID3D11Device::CreateBuffer() for Cube Texcoords Buffer  Failed!!!\n");
		fclose(gpFile);
		return hr;
	}
	else
	{
		fopen_s(&gpFile, "Log.txt", "a+");
		fprintf(gpFile, "Init() in gpID3D11Device::CreateBuffer() for Cube Texcoords Buffer  Successed!!!\n");
		fclose(gpFile);
	}
	...
	hr = gpID3D11Device->CreateBuffer(&d3d11BufferDescriptor,
		&d3d11SubResourceData,
		&gpID3D11Buffer_Position_PyramidBuffer);

	if (FAILED(hr))
	{
		fopen_s(&gpFile, "Log.txt", "a+");
		fprintf(gpFile, "Init() in gpID3D11Device::CreateBuffer() for Pyramid Position Buffer  Failed!!!\n");
		fclose(gpFile);
		return hr;
	}
	else
	{
		fopen_s(&gpFile, "Log.txt", "a+");
		fprintf(gpFile, "Init() in gpID3D11Device::CreateBuffer() for Pyramid Position Buffer  Successed!!!\n");
		fclose(gpFile);
	}
	...
	hr = gpID3D11Device->CreateBuffer(&d3d11BufferDescriptor,
		&d3d11SubResourceData,
		&gpID3D11Buffer_Texture_PyramidBuffer);

	if (FAILED(hr))
	{
		fopen_s(&gpFile, "Log.txt", "a+");
		fprintf(gpFile, "Init() in gpID3D11Device::CreateBuffer() for Pyramid Texcoords Buffer  Failed!!!\n");
		fclose(gpFile);
		return hr;
	}
	else
	{
		fopen_s(&gpFile, "Log.txt", "a+");
		fprintf(gpFile, "Init() in gpID3D11Device::CreateBuffer() for Pyramid Texcoords Buffer  Successed!!!\n");
		fclose(gpFile);
	}
	...
	{
		fopen_s(&gpFile, "Log.txt", "a+");
		fprintf(gpFile, "Init() in loadD3DTexture Pyramid function Failed!!!\n");
		fclose(gpFile);
		return hr;
	}
	else
	{
		fopen_s(&gpFile, "Log.txt", "a+");
		fprintf(gpFile, "Init() in loadD3DTexture function  Pyramid Successed!!!\n");
		fclose(gpFile);
	}
	...
	hr = gpID3D11Device->CreateSamplerState(&d3d11SamplerDescriptor, &gpID3D11SamplerState_Pyramid_Texture);
	if (FAILED(hr))
	{
		fopen_s(&gpFile, "Log.txt", "a+");
		fprintf(gpFile, "Init() in gpID3D11Device::CreateSamplerState() Pyramid Failed!!!\n");
		fclose(gpFile);
		return hr;
	}
	else
	{
		fopen_s(&gpFile, "Log.txt", "a+");
		fprintf(gpFile, "Init() in gpID3D11Device::CreateSamplerState() Pyramid Successed!!!\n");
		fclose(gpFile);
	}
	

	/* Create  Texture samplerstate*/
	hr = loadD3DTexture(L"Vijay_Kundali.bmp", &gpID3D11ShaderResourceView_Cube_Texture);

	if (FAILED(hr))
	{
		fopen_s(&gpFile, "Log.txt", "a+");
		fprintf(gpFile, "Init() in loadD3DTexture Cube function Failed!!!\n");
		fclose(gpFile);
		return hr;
	}
	else
	{
		fopen_s(&gpFile, "Log.txt", "a+");
		fprintf(gpFile, "Init() in loadD3DTexture function  Cube Successed!!!\n");
		fclose(gpFile);
	}
	...
	hr = gpID3D11Device->CreateSamplerState(&d3d11SamplerDescriptor, &gpID3D11SamplerState_Cube_Texture);
	if (FAILED(hr))
	{
		fopen_s(&gpFile, "Log.txt", "a+");
		fprintf(gpFile, "Init() in gpID3D11Device::CreateSamplerState() Cube Failed!!!\n");
		fclose(gpFile);
		return hr;
	}
	else
	{
		fopen_s(&gpFile, "Log.txt", "a+");
		fprintf(gpFile, "Init() in gpID3D11Device::CreateSamplerState() Cube Successed!!!\n");
		fclose(gpFile);
	}
...
void display(void)
{
	...
	/* ========================== Cube Texture =======================  */
	/* Set Texture Buffer in Input Assembly Stage of pipeline */
...
void update(void)
{
	...
	anglePyramid = anglePyramid + 5.0f;
...
void uninitialise(void)
{
	...
	if (gpID3D11Buffer_Texture_CubeBuffer)
	{
		gpID3D11Buffer_Texture_CubeBuffer->Release();
		gpID3D11Buffer_Texture_CubeBuffer = NULL;
	}
	if (gpID3D11Buffer_Texture_PyramidBuffer)
	{
		gpID3D11Buffer_Texture_PyramidBuffer->Release();
		gpID3D11Buffer_Texture_PyramidBuffer = NULL;
	}

	if(gpID3D11Buffer_Position_PyramidBuffer)
	{
		gpID3D11Buffer_Position_PyramidBuffer->Release();
		gpID3D11Buffer_Position_PyramidBuffer = NULL;
	}
